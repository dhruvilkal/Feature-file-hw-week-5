Feature: Book category
  ...
  Scenario Outline: I should book category from top menu tabs on home page

    When  I selected book category from top menu tabs on home page
  ...
  Scenario Outline: I should be able to see products display format accrding display format type as per given picture in srs document
    Given   I am on book page
